...
const FloatingInfoComponent = ({ closeClick, image, type }) => {
  var sectionHeaders = [],
    sectionDesc = [],
    sectionLinks = [],
    fullDescription = "This is a full description";
  var researchFDescription =
    "When referring to the lunar calendars in history you will find hundreds of different iterations all measuring time by the phases of the moon. " +
  ...
  var contactFDescription =
    "The main reason for building Moody has been on not creating one true way to understand what we will feel according to the moon, but to bring the " +
  ...
  var resourcesFDescription =
    "The following are different resources found within New Zealand that offer interesting incite into the workings of Maramataka. " +
  ...
  return (
    <Container>
      ...
      <Parallax
        style={{ height: isTabletOrMobile ? `335px` : "73vh" }}
        bgImage={image}
        strength={500}
      />
      <SectionContainer>
      ...
      <DetailsContainer>
        ...
        <Details>{fullDescription}</Details>
      </DetailsContainer>
      <DetailsContainer>
